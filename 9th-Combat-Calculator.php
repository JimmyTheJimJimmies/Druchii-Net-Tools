<?php 
$title = "Druchii.net - 9th Age Combat Calculator";
...
<div class="container" >
	...
	<div class="page-header">
		<h1>9th Age Combat Calculator</h1>
		<p class="lead">
			Calculate the combat statistics for a combination of profiles.
		</p>
	</div>
	...
	<div class="btn-group">
		<a class="btn btn-default" id="linkpage" target="_blank" title="Open this calculation in new window" href="9th-Combat-Calculator.php?<?php echo $fullquery;?>"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Page</a>
