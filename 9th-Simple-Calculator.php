<?php 
$title = "Druchii.net - 9th Age Simple Calculator";
$description = "Analytical tool for computing the performance of troops in the 9th Age.";
...
$query = (isset($_GET['q']) and preg_match("#^$roll9_exp$#", $_GET['q']))? $_GET['q'] : 'r9:335:10';
...
<div class="container">
	...
	<div class="page-header">
		<h1>9th Age Simple Combat Calculator</h1>
		<p class="lead">
	...
	<div class="row">
		...
		<br/>
		<input type="checkbox" id="lethalstrike" class="hidden" name="rule" value="2" <?php if(in_array(2,$rules)){echo 'checked="checked"';} ?>/>
		<label for="lethalstrike" class="btn btn-default btn-reroll btn-md btn-activate">Lethal Strike</label>	
		</div>
		...
		<br/>
		<input type="checkbox" id="holyattacks" class="hidden"  name="rule" value="3" <?php if(in_array(3,$rules)){echo 'checked="checked"';} ?>/>
		<label for="holyattacks" class="btn btn-default btn-reroll btn-md btn-activate">Holy attacks</label>	
		</div>
	</div>
	...
	<div class="btn-group">
		<a class="btn btn-primary" id="linkpage" target="_blank" title="Open this calculation in the new Combat Calculator" href="9th-Combat-Calculator.php?<?php echo $fullquery;?>"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Page</a>
...
var updateImage = function() {
	query = "r9:" + hitRoller.getValue() + woundRoller.getValue() + saveRoller.getValue() + wardRoller.getValue() 
	...
	linkpage.setAttribute('href', '9th-Combat-Calculator.php?q=' + query+ config);
